...
KEYBOARD_PACKAGE = {
    ...
    FLEKSY10: "com.syntellia.fleksy.keyboard",
}
...
FLEKSY10_LAYOUT = {
    "keyboard_frame": [0, 1625, 1080, 650],
    "lowercase": {
        "q": [0, 110, 108, 135],
        "w": [108, 110, 108, 135],
        "e": [216, 110, 108, 135],
        ...
        "n": [720, 380, 120, 135],
        "m": [840, 380, 120, 135],
        "backspace": [960, 380, 120, 135],
        "numbers": [0, 515, 145, 135],
        "smiley": [145, 515, 140, 135],
        "spacebar": [285, 515, 525, 135],
        ".": [810, 515, 130, 135],
        "enter": [940, 515, 140, 135],
    },
    "uppercase": {
        "Q": [0, 110, 108, 135],
        "W": [108, 110, 108, 135],
    ...
    "numbers": {
        ...
        "#": [786, 380, 98, 135],
        "@": [884, 380, 98, 135],
        "backspace": [982, 380, 98, 135],
        "letters": [0, 515, 145, 135],
        "spacebar": [285, 515, 525, 135],
        ".": [810, 515, 130, 135],
        "enter": [940, 515, 140, 135],
    },
    ...
    def __init__(  # noqa: C901
        ...
        if get_layout:
            if self.keyboard == GBOARD:
                ...
                self.layout = self.detected.layout
            elif self.keyboard == FLEKSY10:
                self.layout = FLEKSY10_LAYOUT
            else:
                raise ValueError(
